...
export class ServicesComponent {
  servicesRoutes = [
    ...
    { 'url': '/reinigung-leder', 'name': 'Reinigung Leder', 'image': 'assets/images/services/leather-cleaning.jpg' },
    { 'url': '/schutz-des-leders', 'name': 'Schutz des Leders', 'image': 'assets/images/services/leather-protection.jpg' },
    { 'url': '/malen-von-leder', 'name': 'Malen von Leder', 'image': 'assets/images/services/leather-painting.jpg' },
