...
export const appRoutes: Routes = [
  ...
  { path: 'dienstleistungen', component: ServicesComponent, data: { animation: 'page2' } },
  { path: 'portfolio', component: PortfolioComponent, data: { animation: 'page3' } },
  { path: 'kontakt', component: ContactComponent, data: { animation: 'page4' } },
  { path: 'door-to-door', component: DoorToDoorComponent, data: { animation: 'page5' } },
  { path: 'detailling-des-innenraumes-standard', component: DetaillingInteriorStandardComponent, data: { animation: 'page6' } },
  { path: 'detailling-des-innenraumes-lux', component: DetaillingInteriorLuxComponent, data: { animation: 'page7' } },
  { path: 'ozonierung', component: OzonationComponent, data: { animation: 'page8' } },
  { path: 'reinigung-des-leders', component: LeatherCleaningComponent, data: { animation: 'page9' } },
  { path: 'cabriodacher-schutz', component: ConvertibleRoofsProtectionComponent, data: { animation: 'page10' } },
  { path: 'cabriodacher-reinigung', component: ConvertibleRoofsCleaningComponent, data: { animation: 'page11' } },
  { path: 'malen-leders', component: LeatherPaintingComponent, data: { animation: 'page12' } },
  { path: 'schutz-des-leders', component: LeatherProtectionComponent, data: { animation: 'page13' } },
  { path: 'instandsetzung-der-lampen', component: LampsRepairComponent, data: { animation: 'page14' } },
  { path: 'lackschutz-wachs', component: PaintProtectionWaxComponent, data: { animation: 'page15' } },
  { path: 'instandsetzung-des-lackes', component: PaintRepairComponent, data: { animation: 'page16' } },
  { path: 'lackschutz-quarzbeschichtung', component: PaintProtectionQuartzComponent, data: { animation: 'page17' } },
  { path: 'lackschutz-keramik', component: PaintProtectionCeramicsComponent, data: { animation: 'page18' } },
  { path: 'nicht-gefunden', component: ErrorPageComponent, data: { animation: 'page19' } },
  // Gallery routes.
  { path: 'portfolio/audi-r8', component: AudiR8Component, data: { animation: 'page20' } },
  { path: 'portfolio/audi-s8-v8-t', component: AudiS8V8TComponent, data: { animation: 'page21' } },
  { path: 'portfolio/audi-sq5', component: AudiSq5Component, data: { animation: 'page22' } },
  { path: 'portfolio/audi-tt-rs', component: AudiTtRsComponent, data: { animation: 'page23' } },
  { path: 'portfolio/bmw-330ci-e46', component: Bmw330ciE46Component, data: { animation: 'page24' } },
  { path: 'portfolio/bmw-gt', component: BmwGtComponent, data: { animation: 'page25' } },
  { path: 'portfolio/camper', component: CamperComponent, data: { animation: 'page26' } },
  { path: 'portfolio/citroen-ds-cabrio', component: CitroenDsCabrioComponent, data: { animation: 'page27' } },
  { path: 'portfolio/corvette-z06', component: CorvetteZ06Component, data: { animation: 'page28' } },
  { path: 'portfolio/ferrari-612-scaglietti', component: Ferrari612ScagliettiComponent, data: { animation: 'page29' } },
  { path: 'portfolio/flugzeug', component: FlugzeugComponent, data: { animation: 'page30' } },
  { path: 'portfolio/ford-fiesta-mk4', component: FordFiestaMk4Component, data: { animation: 'page31' } },
  { path: 'portfolio/ford-mustang-v-coupe', component: FordMustangVCoupeComponent, data: { animation: 'page32' } },
  { path: 'portfolio/golf-iv-gti', component: GolfIvGtiComponent, data: { animation: 'page33' } },
  { path: 'portfolio/infiniti-qx70s', component: InfinitiQx70sComponent, data: { animation: 'page34' } },
  { path: 'portfolio/jaguar-e-type-v12-1973', component: JaguarETypeV121973Component, data: { animation: 'page35' } },
  { path: 'portfolio/jaguar-xj6', component: JaguarXj6Component, data: { animation: 'page36' } },
  { path: 'portfolio/kawasaki-zx10r-ninja', component: KawasakiZx10rNinjaComponent, data: { animation: 'page37' } },
  ...
  { path: 'portfolio/mercedes-sprinter', component: MercedesSprinterComponent, data: { animation: 'page44' } },
  { path: 'portfolio/mercedes-vito', component: MercedesVitoComponent, data: { animation: 'page45' } },
  { path: 'portfolio/mercedes-w111-220seb-coupe-1965', component: MercedesW111220sebCoupe1965Component, data: { animation: 'page46' } },
  { path: 'portfolio/opel-zafira', component: OpelZafiraComponent, data: { animation: 'page47' } },
  { path: 'portfolio/porsche-944', component: Porsche944Component, data: { animation: 'page48' } },
  { path: 'portfolio/range-rover', component: RangeRoverComponent, data: { animation: 'page49' } },
  { path: 'portfolio/range-rover-supercharged-autobiography', component: RangeRoverSuperchargedAutobiographyComponent, data: { animation: 'page50' } },
  { path: 'portfolio/rolls-royce-corniche-iv', component: RollsRoyceCornicheIvComponent, data: { animation: 'page51' } },
  { path: 'portfolio/skoda-fabia', component: SkodaFabiaComponent, data: { animation: 'page52' } },
  { path: 'portfolio/tesla-model-s-85', component: TeslaModelS85Component, data: { animation: 'page53' } },
  { path: 'portfolio/tesla-x', component: TeslaXComponent, data: { animation: 'page54' } },
  { path: 'portfolio/volvo-xc90', component: VolvoXc90Component, data: { animation: 'page55' } },
  { path: 'portfolio/vw-kafer-1965', component: VwKafer1965Component, data: { animation: 'page56' } },
  { path: 'portfolio/vw-multivan-black-white', component: VwMultivanBlackWhiteComponent, data: { animation: 'page57' } },
