...
export const appRoutes: Routes = [
  ...
  { path: 'reinigung-des-leders', component: LeatherCleaningComponent, data: { animation: 'page10' } },
  ...
  { path: 'malen-leders', component: LeatherPaintingComponent, data: { animation: 'page13' } },
  ...
  // Gallery routes.
  { path: 'portfolio/audi-r8', component: AudiR8Component, data: { animation: 'page21' } },
  { path: 'portfolio/audi-s8-v8-t', component: AudiS8V8TComponent, data: { animation: 'page22' } },
  { path: 'portfolio/audi-sq5', component: AudiSq5Component, data: { animation: 'page23' } },
  { path: 'portfolio/audi-tt-rs', component: AudiTtRsComponent, data: { animation: 'page24' } },
  { path: 'portfolio/bmw-330ci-e46', component: Bmw330ciE46Component, data: { animation: 'page25' } },
  { path: 'portfolio/bmw-gt', component: BmwGtComponent, data: { animation: 'page26' } },
  { path: 'portfolio/camper', component: CamperComponent, data: { animation: 'page27' } },
  { path: 'portfolio/citroen-ds-cabrio', component: CitroenDsCabrioComponent, data: { animation: 'page28' } },
  { path: 'portfolio/corvette-z06', component: CorvetteZ06Component, data: { animation: 'page29' } },
  { path: 'portfolio/ferrari-612-scaglietti', component: Ferrari612ScagliettiComponent, data: { animation: 'page30' } },
  { path: 'portfolio/flugzeug', component: FlugzeugComponent, data: { animation: 'page31' } },
  { path: 'portfolio/ford-fiesta-mk4', component: FordFiestaMk4Component, data: { animation: 'page32' } },
  { path: 'portfolio/ford-mustang-v-coupe', component: FordMustangVCoupeComponent, data: { animation: 'page33' } },
  { path: 'portfolio/golf-iv-gti', component: GolfIvGtiComponent, data: { animation: 'page34' } },
  { path: 'portfolio/infiniti-qx70s', component: InfinitiQx70sComponent, data: { animation: 'page35' } },
  { path: 'portfolio/jaguar-e-type-v12-1973', component: JaguarETypeV121973Component, data: { animation: 'page36' } },
